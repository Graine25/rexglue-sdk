...
bool VulkanTextureCache::Initialize() {
  ...
  HostFormatPair& host_format_r5g6b5 =
      host_formats_[uint32_t(xenos::TextureFormat::k_5_6_5)];
  assert_true(host_format_r5g6b5.format_unsigned.format ==
              VK_FORMAT_R5G6B5_UNORM_PACK16);
  ifn.vkGetPhysicalDeviceFormatProperties(
      physical_device, VK_FORMAT_R5G6B5_UNORM_PACK16, &format_properties);
  if ((format_properties.optimalTilingFeatures & kLinearFilterFeatures) !=
      kLinearFilterFeatures) {
    host_format_r5g6b5.format_unsigned.load_shader =
  ...
  load_shader_code[kLoadShaderIndexR5G6B5ToRGBA8] =
      std::make_pair(shaders::texture_load_r5g6b5_rgba8_cs,
                     sizeof(shaders::texture_load_r5g6b5_rgba8_cs));
