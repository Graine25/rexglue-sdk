...
PacketCategory PacketDisassembler::GetPacketCategory(const uint8_t* base_ptr) {
  const uint32_t packet = rex::load_and_swap<uint32_t>(base_ptr);
...
bool PacketDisassembler::DisasmPacketType0(const uint8_t* base_ptr, uint32_t packet,
                                           PacketInfo* out_info) {
  static constexpr PacketTypeInfo type_0_info = {PacketCategory::kGeneric, "PM4_TYPE0"};
  ...
  for (uint32_t m = 0; m < count; m++) {
    uint32_t reg_data = rex::load_and_swap<uint32_t>(ptr);
...
bool PacketDisassembler::DisasmPacketType1(const uint8_t* base_ptr, uint32_t packet,
                                           PacketInfo* out_info) {
  static constexpr PacketTypeInfo type_1_info = {PacketCategory::kGeneric, "PM4_TYPE1"};
  ...
  uint32_t reg_data_1 = rex::load_and_swap<uint32_t>(ptr);
  uint32_t reg_data_2 = rex::load_and_swap<uint32_t>(ptr + 4);
...
bool PacketDisassembler::DisasmPacketType2(const uint8_t* base_ptr, uint32_t packet,
                                           PacketInfo* out_info) {
  static constexpr PacketTypeInfo type_2_info = {PacketCategory::kGeneric, "PM4_TYPE2"};
...
bool PacketDisassembler::DisasmPacketType3(const uint8_t* base_ptr, uint32_t packet,
                                           PacketInfo* out_info) {
  static constexpr PacketTypeInfo type_3_unknown_info = {PacketCategory::kGeneric,
                                                         "PM4_TYPE3_UNKNOWN"};
  ...
  switch (opcode) {
    case PM4_ME_INIT: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_ME_INIT"};
    ...
    case PM4_NOP: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_NOP"};
      out_info->type_info = &op_info;
      break;
    }
    case PM4_INTERRUPT: {
      // generate interrupt from the command stream
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_INTERRUPT"};
      out_info->type_info = &op_info;

      PacketAction intaction;
      intaction.type = Type::kGenInterrupt;
      intaction.gen_interrupt.cpu_mask = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_XE_SWAP: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kSwap, "PM4_XE_SWAP"};
      out_info->type_info = &op_info;

      PacketAction xsa;
      xsa.type = Type::kXeSwap;
      xsa.xe_swap.frontbuffer_ptr = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_INDIRECT_BUFFER_PFD: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_INDIRECT_BUFFER"};
      out_info->type_info = &op_info;

      PacketAction iba;
      iba.type = Type::kIndirBuffer;
      iba.indir_buffer.list_ptr = rex::load_and_swap<uint32_t>(ptr);
      iba.indir_buffer.list_length = rex::load_and_swap<uint32_t>(ptr + 4);
    ...
    case PM4_WAIT_REG_MEM: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_WAIT_REG_MEM"};
      out_info->type_info = &op_info;

      PacketAction wait_action;
      wait_action.type = PacketAction::Type::kWaitRegMem;
      auto& wrm = wait_action.wait_reg_mem;
      wrm.wait_info = rex::load_and_swap<uint32_t>(ptr + 0);
      wrm.poll_reg_addr = rex::load_and_swap<uint32_t>(ptr + 4);
      wrm.ref = rex::load_and_swap<uint32_t>(ptr + 8);
      wrm.mask = rex::load_and_swap<uint32_t>(ptr + 12);
      wrm.wait = rex::load_and_swap<uint32_t>(ptr + 16);
    ...
    case PM4_REG_RMW: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_REG_RMW"};
      out_info->type_info = &op_info;
      PacketAction rmw_action;
      rmw_action.type = PacketAction::Type::kRegRmw;
      auto& rmw = rmw_action.reg_rmw;

      uint32_t rmw_info = rex::load_and_swap<uint32_t>(ptr + 0);

      rmw.rmw_info = rmw_info;

      rmw.and_mask = rex::load_and_swap<uint32_t>(ptr + 4);
      rmw.or_mask = rex::load_and_swap<uint32_t>(ptr + 8);
      out_actions.emplace_back(std::move(rmw_action));
      break;
    }
    case PM4_COND_WRITE: {
      // conditional write to memory or register
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_COND_WRITE"};
      out_info->type_info = &op_info;
      ...
      cwr.wait_info = rex::load_and_swap<uint32_t>(ptr + 0);
      cwr.poll_reg_addr = rex::load_and_swap<uint32_t>(ptr + 4);
      cwr.ref = rex::load_and_swap<uint32_t>(ptr + 8);
      cwr.mask = rex::load_and_swap<uint32_t>(ptr + 12);
      cwr.write_reg_addr = rex::load_and_swap<uint32_t>(ptr + 16);
      cwr.write_data = rex::load_and_swap<uint32_t>(ptr + 20);
    ...
    case PM4_EVENT_WRITE: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_EVENT_WRITE"};
      out_info->type_info = &op_info;
      PacketAction evw_action;
      evw_action.type = Type::kEventWrite;
      evw_action.event_write.initiator = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_EVENT_WRITE_SHD: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_EVENT_WRITE_SHD"};
      out_info->type_info = &op_info;
      PacketAction evws_action;
      evws_action.type = Type::kEventWriteSHD;
      auto& evws = evws_action.event_write_shd;

      evws.initiator = rex::load_and_swap<uint32_t>(ptr + 0);
      evws.address = rex::load_and_swap<uint32_t>(ptr + 4);
      evws.value = rex::load_and_swap<uint32_t>(ptr + 8);
    ...
    case PM4_EVENT_WRITE_EXT: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_EVENT_WRITE_EXT"};
      out_info->type_info = &op_info;

      PacketAction eve_action;
      eve_action.type = Type::kEventWriteExt;
      auto& eve = eve_action.event_write_ext;
      uint32_t unk0 = rex::load_and_swap<uint32_t>(ptr + 0);
      uint32_t unk1 = rex::load_and_swap<uint32_t>(ptr + 4);
    ...
    case PM4_DRAW_INDX: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kDraw, "PM4_DRAW_INDX"};
      out_info->type_info = &op_info;
      uint32_t dword0 = rex::load_and_swap<uint32_t>(ptr + 0);
      uint32_t dword1 = rex::load_and_swap<uint32_t>(ptr + 4);
      ...
      if (src_sel == 0x0) {
        // Indexed draw.
        uint32_t guest_base = rex::load_and_swap<uint32_t>(ptr + 8);
        uint32_t index_size = rex::load_and_swap<uint32_t>(ptr + 12);
    ...
    case PM4_DRAW_INDX_2: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kDraw, "PM4_DRAW_INDX_2"};
      out_info->type_info = &op_info;
      uint32_t dword0 = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_SET_CONSTANT: {
      ...
      //                                     reg - 0x2000
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_CONSTANT"};
      out_info->type_info = &op_info;
      uint32_t offset_type = rex::load_and_swap<uint32_t>(ptr + 0);
      ...
      for (uint32_t n = 0; n < count - 1; n++, index++) {
        uint32_t data = rex::load_and_swap<uint32_t>(ptr + 4 + n * 4);
        out_actions.emplace_back(PacketAction::RegisterWrite(index, data));
      }
      break;
    }
    case PM4_SET_CONSTANT2: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_CONSTANT2"};
      out_info->type_info = &op_info;
      uint32_t offset_type = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_LOAD_ALU_CONSTANT: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_LOAD_ALU_CONSTANT"};
      out_info->type_info = &op_info;
      uint32_t address = rex::load_and_swap<uint32_t>(ptr + 0);
      address &= 0x3FFFFFFF;
      uint32_t offset_type = rex::load_and_swap<uint32_t>(ptr + 4);
      uint32_t index = offset_type & 0x7FF;
      uint32_t size_dwords = rex::load_and_swap<uint32_t>(ptr + 8);
      size_dwords &= 0xFFF;
      uint32_t type = (offset_type >> 16) & 0xFF;
      switch (type) {
        case 0:  // ALU
      ...
      for (uint32_t n = 0; n < size_dwords; n++, index++) {
        // Hrm, ?
        // rex::load_and_swap<uint32_t>(membase_ + GpuToCpu(address + n * 4));
    ...
    case PM4_IM_LOAD: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_IM_LOAD"};
      out_info->type_info = &op_info;
      uint32_t addr_type = rex::load_and_swap<uint32_t>(ptr + 0);
      auto shader_type = static_cast<xenos::ShaderType>(addr_type & 0x3);
      uint32_t addr = addr_type & ~0x3;
      uint32_t start_size = rex::load_and_swap<uint32_t>(ptr + 4);
    ...
    case PM4_IM_LOAD_IMMEDIATE: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_IM_LOAD_IMMEDIATE"};
      out_info->type_info = &op_info;
      uint32_t dword0 = rex::load_and_swap<uint32_t>(ptr + 0);
      uint32_t dword1 = rex::load_and_swap<uint32_t>(ptr + 4);
      ...
      imi_action.InjectBeWords(reinterpret_cast<const uint32_t*>(ptr + 8), size_dwords);
    ...
    case PM4_INVALIDATE_STATE: {
      ...
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_INVALIDATE_STATE"};
      out_info->type_info = &op_info;
      uint32_t mask = rex::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_SET_BIN_MASK_LO: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_BIN_MASK_LO"};
      out_info->type_info = &op_info;
      uint32_t value = rex::load_and_swap<uint32_t>(ptr);
    ...
    case PM4_SET_BIN_MASK_HI: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_BIN_MASK_HI"};
      out_info->type_info = &op_info;
      uint32_t value = rex::load_and_swap<uint32_t>(ptr);
    ...
    case PM4_SET_BIN_SELECT_LO: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_BIN_SELECT_LO"};
      out_info->type_info = &op_info;
      uint32_t value = rex::load_and_swap<uint32_t>(ptr);
      PacketAction action;
    ...
    case PM4_SET_BIN_SELECT_HI: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_BIN_SELECT_HI"};
      out_info->type_info = &op_info;
      uint32_t value = rex::load_and_swap<uint32_t>(ptr);
    ...
    case PM4_MEM_WRITE: {
      ...
      uint32_t write_addr = rex::load_and_swap<uint32_t>(ptr);
      ...
      for (uint32_t i = 0; i < count - 1; i++) {
        uint32_t write_data = rex::load_and_swap<uint32_t>(&ptr[(i + 1) * 4]);
    ...
    case PM4_REG_TO_MEM: {
      ...
      r2m.reg2mem.reg_addr = rex::load_and_swap<uint32_t>(ptr);
      uint32_t dword1 = rex::load_and_swap<uint32_t>(ptr + 4);
    ...
    case 0x50: {  // 0xC0015000 usually 2 words, 0xFFFFFFFF / 0x00000000
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_TYPE3_0x50"};
      out_info->type_info = &op_info;
      break;
    }
    case 0x51: {  // 0xC0015100 usually 2 words, 0xFFFFFFFF / 0xFFFFFFFF
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_TYPE3_0x51"};
      out_info->type_info = &op_info;
      break;
    }
    default: {
