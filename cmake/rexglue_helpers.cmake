...
function(rexglue_configure_target target_name)
    ...
    if(TARGET imgui::imgui)
        get_target_property(_rexglue_imgui_include_dirs imgui::imgui INTERFACE_INCLUDE_DIRECTORIES)
        if(_rexglue_imgui_include_dirs)
            target_include_directories(${target_name} PRIVATE ${_rexglue_imgui_include_dirs})
        endif()
    endif()
