...
// ReXGlue: the vendored glslang predates <SPIRV/spirv.hpp11>; its <SPIRV/spirv.hpp> is unscoped.
#if __has_include(<SPIRV/spirv.hpp11>)
#define REX_SPIRV_GLSLANG_SCOPED_ENUMS 1
#else
#define REX_SPIRV_GLSLANG_SCOPED_ENUMS 0
#endif
#if !REX_SPIRV_GLSLANG_SCOPED_ENUMS
#include <SPIRV/spirv.hpp>
#else  // !REX_SPIRV_GLSLANG_SCOPED_ENUMS

#include <SPIRV/spirv.hpp11>
#include <SPIRV/spvUtil.h>
...
#define OpGetKernelPreferredWorkGroupSizeMultiple Op::OpGetKernelPreferredWorkGroupSizeMultiple
...
#define OpImageSparseSampleDrefImplicitLod Op::OpImageSparseSampleDrefImplicitLod
#define OpImageSparseSampleDrefExplicitLod Op::OpImageSparseSampleDrefExplicitLod
#define OpImageSparseSampleProjImplicitLod Op::OpImageSparseSampleProjImplicitLod
#define OpImageSparseSampleProjExplicitLod Op::OpImageSparseSampleProjExplicitLod
#define OpImageSparseSampleProjDrefImplicitLod Op::OpImageSparseSampleProjDrefImplicitLod
#define OpImageSparseSampleProjDrefExplicitLod Op::OpImageSparseSampleProjDrefExplicitLod
...
#define CapabilityFragmentShaderSampleInterlockEXT Capability::FragmentShaderSampleInterlockEXT
#define CapabilityFragmentShaderPixelInterlockEXT Capability::FragmentShaderPixelInterlockEXT
#define CapabilitySampleRateShading Capability::SampleRateShading
#define CapabilityDemoteToHelperInvocationEXT Capability::DemoteToHelperInvocationEXT
...
#define ExecutionModeSignedZeroInfNanPreserve ExecutionMode::SignedZeroInfNanPreserve
#define ExecutionModeRoundingModeRTE ExecutionMode::RoundingModeRTE
#define ExecutionModePixelInterlockOrderedEXT ExecutionMode::PixelInterlockOrderedEXT
#define ExecutionModeSampleInterlockOrderedEXT ExecutionMode::SampleInterlockOrderedEXT
...
// ReXGlue: unscoped BuiltIn names, as required by the vendored glslang.
#define BuiltInClipDistance BuiltIn::ClipDistance
#define BuiltInCullDistance BuiltIn::CullDistance
#define BuiltInFragCoord BuiltIn::FragCoord
#define BuiltInFragDepth BuiltIn::FragDepth
#define BuiltInFragStencilRefEXT BuiltIn::FragStencilRefEXT
#define BuiltInFrontFacing BuiltIn::FrontFacing
#define BuiltInGlobalInvocationId BuiltIn::GlobalInvocationId
#define BuiltInPosition BuiltIn::Position
#define BuiltInSampleId BuiltIn::SampleId
#define BuiltInSampleMask BuiltIn::SampleMask
#define BuiltInTessCoord BuiltIn::TessCoord
#define BuiltInVertexIndex BuiltIn::VertexIndex
